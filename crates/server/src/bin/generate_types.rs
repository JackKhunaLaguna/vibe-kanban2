...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::review::AnalyzeReviewRequest::decl(),
        server::routes::review::AnalyzeReviewResponse::decl(),
        server::routes::review::CompleteReview::decl(),
        server::routes::review::TaskReview::decl(),
        server::routes::review::ReviewFinding::decl(),
        server::routes::review::ReviewSummary::decl(),
