...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::tasks::GenerateTaskRequest::decl(),
        server::routes::tasks::GenerateTaskResponse::decl(),
        server::routes::tasks::BreakdownTaskResponse::decl(),
        server::routes::tasks::FeatureBreakdownResponse::decl(),
        server::routes::tasks::BreakdownFeatureRequest::decl(),
        server::routes::tasks::ConversationMessageRequest::decl(),
        server::routes::tasks::BulkCreateTasksRequest::decl(),
        server::routes::tasks::BulkCreateTaskInput::decl(),
        server::routes::tasks::BulkCreateTasksResponse::decl(),
